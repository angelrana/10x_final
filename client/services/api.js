...
export const getblogsId = (blogsId) => {
  return getApi(`blogs/${blogsId}`);
};

  export const getblogId = async (blogsId) => {
    try {
      await axios.post(`http://localhost:7000/blogs/feature/blogs${blogsId}`);
    } catch (error) {
