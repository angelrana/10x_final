          ...
          <div className={styles.articleSection}>
            ...
            <div className={styles.sectionthree}>
              <div className={styles.sectionThreePartOne}>
                ...
                <div>
                  <h4 className={styles.sectionThreeText}>A 2022 Guide to How to Build Your own Mobile App</h4>
                  <a>Read More</a>
                </div>
              </div>
              ...
              <div className={styles.sectionThreePartTwo}>
                ...
                <div>
                  <h4 className={styles.sectionThreeText}>Bioinformatics and its Sub Disciplines</h4>
                  <a>Read More</a>
                </div>
              </div>
            </div>
